...
var N3 = {
    ...
    capabilities: {
        // AUTHENTICATION
        1: ["UIDL", "APOP", "RESP-CODES", "AUTH-RESP-CODE"],
        // TRANSACTION
        2: ["UIDL", "EXPIRE NEVER", "LOGIN-DELAY 0"],
        // UPDATE
        3: []
    },
 ...
 * 
 **/
// kill client after 5 min on inactivity
...
N3.POP3Server.prototype.cmdQUIT = function(){
    ...
    this.response("+OK POP3 server closing connection");
    this.socket.end();
};
